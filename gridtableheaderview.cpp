    ...
    : QHeaderView (orientation, parent)
{
    ...
    connect(this, &QHeaderView::sectionResized, this, &GridTableHeaderView::slotSectionResized);
#else
...
void GridTableHeaderView::slotSectionResized(int logicalIndex, int oldSize, int newSize)
{
    Q_UNUSED(oldSize)
